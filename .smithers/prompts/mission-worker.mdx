...
5. Never run scripts/install-symlinks.sh. It is a manual, human-only system installation tool. Use `lake build` to verify compilation and run tests/sandbox scripts for validation instead.
