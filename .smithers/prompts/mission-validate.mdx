...
IMPORTANT: Never run scripts/install-symlinks.sh. It is a manual, human-only tool for system-wide installation and will pollute the user's PATH with work-in-progress wrappers.
